...
# Requires pip install pyserial or pip3 install pyserial
...
def main():
    ...
    try:
        ...
        print("Error while opening /dev/ttyUSB0 --> serial.serialutil.SerialException")
    ...
    while True:
        ...
        while ser.inWaiting() >= 2:
            ...
            datalog.write(str(int.from_bytes(l_readin, byteorder='big')) + "\n")
